...
/**
 * Class CourseAdministrationMultiSignoutSelectFormGUI
 *
 * @package srag\Plugins\SrLpReport\Staff\CourseAdministratio
 *
 * @author   Jephte Abijuru<jephte.abijuru@minervis.com>
 */
class CourseAdministrationMultiSignoutSelectFormGUI extends PropertyFormGUI
{
    ...
    {
        $this->addCommandButton(CourseAdministrationStaffGUI::CMD_MULTI_SIGNOUT, $this->txt("signout"));
